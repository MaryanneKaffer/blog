    ...
    return (
        <section className="w-[100%] flex flex-col gap-7">
            ...
            <div className="flex flex-wrap w-full relative lg:justify-normal justify-between">
                {posts.map((post, i) => (
                    <div key={i} className="lg:w-[20%] w-[48%] relative group hover:scale-[1.008] lg:bg-transparent bg-default/45 transition-all relative hover:dark:bg-default/40 hover:bg-default/50 backdrop-blur-md lg:p-5 p-2">
