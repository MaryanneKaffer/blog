    ...
    return (
        <section className="h-[100dvh] w-full py-16">
            <div className="flex gap-7 w-full h-full">
                <div className="flex relative h-[80dvh] w-full group hover:scale-[1.008] transition-all overflow-hidden">
                    ...
                    <div className="flex h-full bg-gradient-to-b from-transparent group-hover:bg-black/60 via-transparent to-black/75 transition-colors duration-400 p-5 cursor-pointer">
                        <span className="h-[35%] group-hover:h-[100%] flex flex-col gap-5 mt-auto transition-all duration-400">
                            ...
                            <span className="flex text-white group-hover:opacity-100 opacity-0 absolute bottom-0 w-full z-10 lg:h-42 h-32 bg-gradient-to-b from-transparent to-black lg:text-5xl text-4xl">
