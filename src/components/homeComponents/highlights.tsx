...
export default function Highlights() {
    ...
    return (
        <section className="flex flex-col gap-3 h-[100%]">
            ...
            <div className="flex lg:flex-row flex-col gap-3 relative">
                <div className="flex flex-col lg:h-[75%] h-[55%] lg:bg-transparent bg-default/45 relative group hover:scale-[1.008] transition-all hover:dark:bg-default/40 hover:bg-default/50 backdrop-blur-md gap-3 lg:p-5 p-3 relative lg:max-w-[30%]">
                    <img className="object-cover lg:h-[350px] sm:h-[300px] h-[200px]" src={best.squarePicture} />
                ...
                <div className="grid relative w-full h-full lg:grid-cols-3 grid-cols-2 gap-3">
                    {side.map((post, i) => (
                        <div key={i} className="relative group hover:scale-[1.008] lg:bg-transparent bg-default/45 transition-all relative hover:dark:bg-default/40 hover:bg-default/50 backdrop-blur-md lg:p-5 p-2">
                            <img className="object-cover lg:h-[170px]" src={post.fullPicture} />
                            <div className="w-full transition-all duration-400 flex flex-col h-full">
                                ...
                                <p className="lg:text-sm text-[0.7rem] lg:line-clamp-5 line-clamp-11">{post[language].resume}</p>
                                <span className="flex justify-between lg:mt-4 mt-2">
