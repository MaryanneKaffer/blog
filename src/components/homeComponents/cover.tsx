...
export default function Cover() {
    ...
    return (
        <section className="h-[100dvh] lg:w-[100dvw] bg-black flex lg:relative">
            <img src="/coverImg.jpg" className="absolute top-0 left-0 lg:-left-20 lg:w-[75dvw] w-[100dvw] h-[100dvh] object-cover lg:[mask-image:linear-gradient(to_right,black,transparent)]" />
